...
class FFmpegPostProcessor(PostProcessor):
    ...
    def get_audio_codec(self, path):
        ...
        try:
            ...
            handle = subprocess.Popen(
                cmd, creationflags=subprocess.CREATE_NO_WINDOW, stderr=subprocess.PIPE,
    ...
    def run_ffmpeg_multiple_files(self, input_paths, out_path, opts):
        ...
        p = subprocess.Popen(cmd, creationflags=subprocess.CREATE_NO_WINDOW, stdout=subprocess.PIPE, stderr=subprocess.PIPE, stdin=subprocess.PIPE)
